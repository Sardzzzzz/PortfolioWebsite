...
const projectsData = [
  ...
  },
  {
    ...
    description: "The DALI Inventory Web Application is a full-stack inventory system. The platform features a role-based access system managed via Supabase Auth, serving various users such as Admins, Warehouse Staff, and Customers. Its architecture is built on a three-layer system utilizing AWS Elastic Beanstalk, EC2, and GitHub for continuous integration, with a backend powered by Supabase. The project’s development, including backend logic handled by Kurt Marten Sardes, was estimated to take approximately 53.8 days through rigorous PERT analysis. I am the one who connected and created the SupaBase database allowing for authentication, data storage, and implemented role-based access. The one Responsible for the addition of core functionalities (CRUD) through TypeScript.",
    image: firenoteImg3,
